...
// //     //           </a>
// //     //           <div>
// //     //             <div className="logo-title">EXO<span className="accent">DIOS</span></div>
...
// //           <Routes>
// //             <Route path="/" element={<WelcomeView results={results} setResults={setResults} />} />


// //             <Route path="/direct-imaging" element={<HomeView />} />
...
//     <Route path="/" element={
//       <WelcomeView results={results} setResults={setResults} />
//     } />

//     {/* Protected / styled pages */}
    ...
    <Router>
      <Routes>
        ...
        <Route path="/services" element={
          <Service results={results} setResults={setResults} />
        } />

        <Route element={<AppLayout />}>
          <Route path="/direct-imaging" element={<HomeView results={results} setResults={setResults} />} />
          <Route path="/transit" element={<TransitView />} />
          <Route path="/hybrid" element={<HybridView />} />
        </Route>
      </Routes>
